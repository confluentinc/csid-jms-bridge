...
public class ConfluentAmqServerTests {
    ...
    public static void setupAll() throws Exception {
        ...
        kafkaProps.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaContainer.getBootstrapServers());
        ...
        amqConf.setNodeManagerLockDirectory(amqDataDir.newFolder("node-manager-lock").getAbsolutePath());
    ...
    public <K, V> List<ConsumerRecord<K, V>> consumeAllRecords(String topic, Deserializer<K> keydeser, Deserializer<V> valuedeser) {
