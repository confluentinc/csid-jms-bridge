...
public class KafkaIO {
    ...
    private static final MessageAdapter NOP_MSG_ADAPTER = new MessageAdapter() {
        ...
        @Override
        public Message transform(ConsumerRecord<byte[], byte[]> kafkaRecord) { return null; }
    };
    ...
    public synchronized void start() {
        kafkaConsumer = new KafkaConsumer<>(kafkaProps, new ByteArrayDeserializer(), new ByteArrayDeserializer());
    ...
    public void createTopic(String name, int partitions, int replication, Map<String, String> options) {
