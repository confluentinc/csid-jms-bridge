...
public class ArtemisTestServer implements
    ...
    public static ArtemisTestServer embedded(
            Properties kafkaProps, Consumer<Builder> serverSpecBuilder, Consumer<JmsCnxnSpec.Builder> cnxnSpecBuilder) {

        return new Factory(TEST_SEQ.getAndIncrement()).embedded(kafkaProps, serverSpecBuilder, cnxnSpecBuilder);
    }
    ...
    private void beforeAll() throws Exception {
        ...
        if (this.cnxnSpecBuilder != null) {
            JmsCnxnSpec.Builder cnxnBuilder = new JmsCnxnSpec.Builder();
            cnxnSpecBuilder.accept(cnxnBuilder);
            this.cnxnSpec = cnxnBuilder.build();
        }
    ...
    public static class Factory {
        ...
        public ArtemisTestServer start() throws Exception {
            ArtemisTestServer testServer = embedded(kafkaProperties, preppedServerSpecBuilder, null);
